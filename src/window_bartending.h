...
#ifndef EP_WINDOW_BARTENDING_H
#define EP_WINDOW_BARTENDING_H
 ...
 */
class Window_Bartending: public Window_Selectable {
public:
	/**
	 * Constructor.
	 *
	 ...
	 */
	Window_Bartending(std::vector<std::string> commands, std::vector<std::string> discriptions, std::vector<std::string> pictures, int width = -1, int max_item = -1);
