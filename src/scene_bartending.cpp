...
void Scene_Bartending::CreateBartendingWindow() {
	...
	bartending_options = {"Mojito", "Long Island Iced Tea", "Margarita", "Blue Hawaii", "Negroni", "Piña colada", "Bomb shot", "Clover Club", "Cosmopolitan", "White Lady", "Zombie", "Rum", "Beer", "Vodka", "Martini"};
